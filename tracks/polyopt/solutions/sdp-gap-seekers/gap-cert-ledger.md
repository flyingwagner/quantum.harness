...
| Kagome Heisenberg | `N=13, d=3, lso=5`, sign-symmetric | `(1.270,1.272]` | original/dedup/uniform/congruence/unit-ray residuals `3.2457e-11` / `3.0798e-10` / `9.9149e-12` / `7.0496e-11` / `9.9912e-11` at tolerance `1e-12` | numerical instability; γ=1.272 is not infeasible or certified |
...
- **Kagome:** the transition is numerical only. Do not move an upper bound
  ...
  removed arbitrary scale but failed at `9.9912e-11`.
...
1. Apply only positive row equilibration to the unit-improvement homogeneous
   feasibility model; do not combine with variable scaling, deduplication, or
   verifier-tolerance changes.
